...
let chooseProject = document.getElementById('chooseProject');
...
function clearErrors(elem) {
    let item = elem.closest("div").querySelectorAll('p.error');
    if (item.length !== 0) {
        item[0].remove();
    }
}
...
let scrolling = document.getElementById.bind(document),
